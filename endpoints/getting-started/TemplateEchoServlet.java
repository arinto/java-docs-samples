...
import com.example.endpoints.com.example.model.ModdedEcho;
...
public class EchoServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
    ...
    try {
      ...
      Map requestBody = new Gson().fromJson(jsonReader, Map.class);
      responseBody = new ModdedEcho(req.getRequestURL().toString(), requestBody);
